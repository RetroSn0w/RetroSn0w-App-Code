...
mkdir temp
cd ..
mv ~/Downloads/iPad_64bit_10.3.3_14G60_Restore.ipsw iPad4,6
cd iPad4,6/work
...
./tools/dependencies/libirecovery/tools/irecovery -f iPad4,6/temp/iBSS.ipad4b.RELEASE.im4p
./tools/dependencies/libirecovery/tools/irecovery -f iPad4,6/temp/iBEC.ipad4b.RELEASE.im4p
sleep 5
