...
mkdir temp
cd ..
mv ~/Downloads/iPhone_4.0_64bit_10.3.3_14G60_Restore.ipsw iPhone6,2
cd iPhone6,2/work
unzip ../iPhone_4.0_64bit_10.3.3_14G60_Restore.ipsw
cd ..
cd temp
...
./tools/dependencies/libirecovery/tools/irecovery -f iPhone6,2/temp/iBSS.iphone6.RELEASE.im4p
./tools/dependencies/libirecovery/tools/irecovery -f iPhone6,2/temp/iBEC.iphone6.RELEASE.im4p
sleep 5
...
rm -rf temp
rm -rf work
mv *.ipsw ~/Downloads/iPhone_4.0_64bit_10.3.3_14G60_Restore.ipsw
cd ..
rm -rf blob.shsh2
